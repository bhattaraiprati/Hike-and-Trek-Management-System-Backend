...
public class RagService {
    ...
    /**
     * Indexes trek/event data into Qdrant vector store
     */
//    public void indexTrekData(List<Map<String, Object>> trekData) {
//        List<Document> documents = trekData.stream()
//                .map(data -> new Document(
//                        (String) data.get("text"),  // main content to embed
//                        Map.of(
...
//    }
    ...
    /**
     * Simple RAG question answering using QuestionAnswerAdvisor
     * Uses default retrieval settings
     */
...
//    }
    ...
    /**
     * RAG with custom system instructions (recommended for better control)
     */
//    public String askWithInstructions(String question) {
//        QuestionAnswerAdvisor qaAdvisor = new QuestionAnswerAdvisor(vectorStore);
//
//        return chatClientBuilder.build()
//                .prompt()
...
//                        Answer only based on the provided context from the vector store.
...
//    }
    ...
    /**
     * RAG with custom SearchRequest for M4
     * In M4, SearchRequest uses static factory method or constructor
     */
//    public String askQuestionAdvanced(String question) {
//        // Correct way for Spring AI 1.0.0-M4
...
//    }
    ...
    /**
     * Alternative: Create SearchRequest using defaults then customize
     */
//    public String askQuestionCustom(String question, int topK, double similarityThreshold) {
//        SearchRequest searchRequest = SearchRequest.query(question)
//                .withTopK(topK)
